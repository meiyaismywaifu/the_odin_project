...
describe 'one word palindrome test' do
  ...
  matcher :be_a_palindrome do
    ...
    ### what should be the hierarchy of describe/context? describe is always a class?
    ### aren't these [it]s a bit undescriptive? shouldn't it say "racecar is a palindrome" and not "is a palindrome"? oh no i see, point is it's an example of one, which here is the [context]....
    ### ...

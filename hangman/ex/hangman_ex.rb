# this is a copy from some point in time.
# didn't want to expand all the scope but also didn't want to dispose ideas.
# needed to clean actual file for readability.
